...
func (x *Owned) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Owned) ProtoMessage() {}

func (x *Owned) ProtoReflect() protoreflect.Message {
	mi := &file_components_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Owned.ProtoReflect.Descriptor instead.
func (*Owned) Descriptor() ([]byte, []int) {
	return file_components_proto_rawDescGZIP(), []int{6}
}

func (x *Owned) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
var file_components_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x05, 0x63, 0x6f, 0x6c, 0x6f, 0x72, 0x22, 0x1e, 0x0a, 0x08, 0x52, 0x65, 0x61, 0x64,
	0x61, 0x62, 0x6c, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x65, 0x78, 0x74, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x74, 0x65, 0x78, 0x74, 0x22, 0x1b, 0x0a, 0x05, 0x4f, 0x77, 0x6e, 0x65,
	0x64, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x65, 0x78, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x74, 0x65, 0x78, 0x74, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6f, 0x64, 0x65, 0x2d, 0x63, 0x65, 0x6c, 0x6c, 0x2f, 0x65, 0x73,
	0x69, 0x76, 0x65, 0x2f, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x73, 0x62, 0x06,
...
var file_components_proto_goTypes = []interface{}{
	...
	(*Readable)(nil), // 5: components.Readable
	(*Owned)(nil),    // 6: components.Owned
}
